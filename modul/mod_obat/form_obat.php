     ...
     <form action="<?php echo"../../modul/mod_$modul/aksi_$modul.php?module=$modul&act=input"; ?>" method="post" name="formData" enctype="multipart/form-data"  > 
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12" >
                 <input type="text" name='obat' name='obat' value="<?php echo @$data->obat?>" autofocus required="required" class="form-control col-md-7 col-xs-12">
              </div>
          </div>
        ...
        while ($row = mysql_fetch_object($query)) {
            ...
            echo '>'.$row->satuan.'</option>';
             ...
             <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12" >
                 <input type="text" style="text-align: right;" name='jumlah' name='jumlah' value="<?php echo @$data->jumlah?>" class="form-control col-md-7 col-xs-12">
              </div>
          </div>    
