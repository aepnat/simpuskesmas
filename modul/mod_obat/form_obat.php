...
<body style='background-color:#fff;'>
    ...
    <div class="ix_panel">
        ...
        <form action="<?php echo" ../../modul/mod_$modul/aksi_$modul.php?module=$modul&act=input"; ?>" method="post"
            name="formData" enctype="multipart/form-data" >

            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Nama Obat :</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name='obat' name='obat' value="<?php echo @$data->obat?>" autofocus required="required"
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Jumlah :</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" style="text-align: right;" name='jumlah' name='jumlah' value="<?php echo @$data->jumlah?>"
                            class="form-control col-md-7 col-xs-12">
                    </div>
                </div>

                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Tanggal Kadaluwarsa :</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="date" name='kadaluwarsa' name='kadaluwarsa' value="<?php echo @$data->kadaluwarsa?>"
                            autofocus required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
