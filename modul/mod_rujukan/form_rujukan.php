     ...
     <form action="<?php echo"../../modul/mod_$modul/aksi_$modul.php?module=$modul&act=input"; ?>" method="post" name="formData" enctype="multipart/form-data"  > 
           ...
           <?php if ($id){ ?>  
            ...
            <?php if (@$data->tipe=='R'){ ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type=radio name='tipe' value='R' checked class="flat">RS/Klinik        
            ...
            <?php   }else{ ?>  
                ...
                <div class="form-group">
                   <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Tipe :</label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                     <input type=radio name='tipe' value='R' class="flat">RS/Klinik        
        ...
        <?php   }else{ ?>  
                ...
                <div class="form-group">
                   <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Tipe :</label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                     <input type=radio name='tipe' value='R' class="flat" checked>RS/Klinik        
                    <input type=radio name='tipe' value='L' class="flat" > Lab                
                  </div>
              </div>  
        ...
        <?php } ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12" >
                 <input type="text" name='rujukan' name='rujukan' value="<?php echo @$data->rujukan?>" autofocus required="required" class="form-control col-md-7 col-xs-12">
              </div>
          </div>
        ...
        <?php } ?>
             ...
             <div class="form-group">
               <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3" style='margin-top:20px;'>
                  <input type="hidden" name="ID" value="<?php echo @$data->id_rujukan?>" />
