...
<div class="ix_panel">
     ...
     <form action="<?php echo"../../modul/mod_$modul/aksi_$modul.php?module=$modul&act=input"; ?>" method="post" name="formData" enctype="multipart/form-data"  > 
            ...
            <div class="form-group">
	               <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Kategori :</label>
              <div class="col-md-6 col-sm-6 col-xs-12" >
                 <input type="text" name='kategori' name='kategori' value="<?php echo @$data->kategori?>" autofocus required="required" class="form-control col-md-7 col-xs-12">
              </div>
          </div>
