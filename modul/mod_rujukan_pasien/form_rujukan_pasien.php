...
<div class="ix_panel">
     ...
     <form action="<?php echo"../../modul/mod_$modul/aksi_$modul.php?module=$modul&act=update"; ?>" method="post" name="formData" enctype="multipart/form-data"  > 
        ...
        if ($query && mysql_num_rows($query) > 0) {
           ...
           <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Rujukan RS :</label>
              <div class="col-md-6 col-sm-6 col-xs-12" >
        ...
        if ($query && mysql_num_rows($query) > 0) {
            while ($row = mysql_fetch_object($query)) {
              ...
              <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Rujukan Lab :</label>
              <div class="col-md-6 col-sm-6 col-xs-12" >
