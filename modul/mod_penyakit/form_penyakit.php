...
<body style='background-color:#fff;'>
    <?php
        ...
        $id = isset($_GET['id_penyakit']) ? intval($_GET['id_penyakit']) : false;

        if ($id) {
            $query = mysql_query('SELECT * FROM penyakit WHERE id_penyakit = "'.$id.'"');
    ...
    <div class="ix_panel">
        ...
        <form action="<?php echo" ../../modul/mod_$modul/aksi_$modul.php?module=$modul&act=input"; ?>" method="post"
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Nama Penyakit :</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name='penyakit' name='penyakit' value="<?php echo @$data->penyakit?>" autofocus
