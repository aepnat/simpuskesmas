...
<div class="ix_panel">
     ...
     <form action="<?php echo"../../modul/mod_$modul/aksi_$modul.php?module=$modul&act=update"; ?>" method="post" name="formData" enctype="multipart/form-data"  > 
        ...
        if ($query && mysql_num_rows($query) > 0) {
            ...
            <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Pemeriksaan :</label>
              <div class="col-md-6 col-sm-6 col-xs-12" >
                 <textarea  class="form-control" name="pemeriksaan" style="height:60px;"><?php echo @$data->pemeriksaan?></textarea>       
            </div>

            <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Tindakan :</label>
              <div class="col-md-6 col-sm-6 col-xs-12" >
