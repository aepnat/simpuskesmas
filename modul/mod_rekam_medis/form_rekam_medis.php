...
$modul = $_GET['module'];
    ...
    <div class="ix_panel">
        ...
        <form action="<?php echo" ../../modul/mod_$modul/aksi_$modul.php?module=$modul&act=update"; ?>" method="post"
            name="formData" enctype="multipart/form-data" >

            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Tanggal</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="date" name='tanggal' name='tanggal' disabled value="<?php echo @$tanggal?>" autofocus
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select name="pasien" class="form-control" disabled>
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Penyakit :</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea class="form-control" name="keluhan" style="height:60px;"><?php echo @$data->keluhan?></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea class="form-control" name="diagnosa" style="height:60px;"><?php echo @$data->diagnosa?></textarea>
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Pemeriksaan
                    :</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea class="form-control" name="pemeriksaan" style="height:60px;"><?php echo @$data->pemeriksaan?></textarea>
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Tindakan
                    :</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea class="form-control" name="tindakan" style="height:60px;"><?php echo @$data->tindakan?></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Rujukan
                    :</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type=radio name='rujukan' value='Y' checked class="flat">Y
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Rujukan
                    :</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type=radio name='rujukan' value='Y' class="flat">Y
