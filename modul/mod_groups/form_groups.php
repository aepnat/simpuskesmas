     ...
     <form action="<?php echo"../../modul/mod_$modul/aksi_$modul.php?module=$modul&act=input"; ?>" method="post" name="formData" enctype="multipart/form-data"  > 
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12" >
                 <input type="text" name='groups' name='groups' value="<?php echo @$data->groups?>" autofocus required="required" class="form-control col-md-7 col-xs-12">
              </div>
          </div>

        <!--   <div class="form-group">
                   <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Halaman Utama :</label>
              <div class="col-md-6 col-sm-6 col-xs-12" >
                 <input type="text" name='main_page' name='main_page' value="<?php echo @$data->main_page?>" class="form-control col-md-7 col-xs-12">
              </div>
          </div> -->
        ...
        <?php } ?>
             ...
             <div class="form-group">
               <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3" style='margin-top:20px;'>
                  <input type="hidden" name="ID" value="<?php echo @$data->id_groups?>" />
