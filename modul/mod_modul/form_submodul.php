...
<form action=" <?php echo"../../modul/mod_$modul/aksi_$modul.php?module=$modul&act=subinput"; ?>" method="post" id="formData" onSubmit="return submitForm();"> 
     
           
            <div class="form-group">
	           <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Modul :</label>
              <div class="col-md-6 col-sm-6 col-xs-12" >
                 <input type="text" name='nama_modul' name='nama_modul' value="<?php echo @$data->nama_modul?>" autofocus required="required" class="form-control col-md-7 col-xs-12">
              </div>
          </div>

          
            <div class="form-group">
	           <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Link :</label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                 <input type="text" name='link' value="<?php echo @$data->link?>" class="form-control col-md-7 col-xs-12">
              </div>
          </div>    

          
            <div class="form-group">
	           <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Urutan :</label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                 <input type="text" name='urutan' value="<?php echo @$data->urutan?>" required="required" class="form-control col-md-7 col-xs-12">
              </div>
          </div>  
          ...
          <?php if ($id) {
            ...
            <?php if (@$data->is_form == 'Y') {
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type=radio name='is_form' value='Y' checked class="flat">Y         
            ...
            <?php
                ...
                <div class="form-group">
	               <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Is Form :</label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                     <input type=radio name='is_form' value='Y' class="flat">Y         
        ...
        <?php if ($id) {
            ...
            <?php if (@$data->is_report == 'Y') {
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type=radio name='is_report' value='Y' checked class="flat">Y         
            ...
            <?php
                ...
                <div class="form-group">
	                 <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Is Report :</label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                     <input type=radio name='is_report' value='Y' class="flat">Y         
        ...
        <?php
            ...
            <div class="form-group">
	               <label class="control-label col-md-3 col-sm-3 col-xs-12" style='padding-top:10px;'>Icon :</label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                 <input type="text" name='icon' value="<?php echo @$data->icon?>" required="required" class="form-control col-md-7 col-xs-12">
              </div>
          </div>  
